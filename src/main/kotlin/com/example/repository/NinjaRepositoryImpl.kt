...
class NinjaRepositoryImpl : NinjaRepository {
    ...
    override val page1 by lazy { listOf(
        Ninja(
            id = 1,
            name = "Sasuke",
    ...
    override val page2 by lazy { listOf(
        Ninja(
            id = 4,
            name = "Boruto",
    ...
    override val page3 by lazy { listOf(
        Ninja(
            id = 7,
            name = "Kawaki",
    ...
    override val page4 by lazy { listOf(
        Ninja(
            id = 10,
            name = "Isshiki",
    ...
    override val page5 by lazy { listOf(
        Ninja(
            id = 13,
            name = "Code",
